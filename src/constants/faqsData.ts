...
export const ALL_FAQS: FAQCategory[] = [
  {
    ...
    items: [
      ...
      { q: "How can I start a partnership with Chalky Infotech?", a: "You can start by contacting us through our website, emailing info@chalkyinfo.com, or scheduling a consultation with one of our sector-specific recruitment directors." },
