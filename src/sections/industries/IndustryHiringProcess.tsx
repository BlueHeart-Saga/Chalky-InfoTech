...
import { Search, Compass, ShieldCheck, UserCheck, CalendarDays, Rocket, ChevronRight } from 'lucide-react';

const STEPS = [
  { title: 'Requirement Discovery', icon: Search, desc: 'Analyzing your sector-specific culture and technical goals.' },
  { title: 'Industry Mapping', icon: Compass, desc: 'Deep market research to identify top talent in your niche.' },
  { title: 'Talent Sourcing', icon: ShieldCheck, desc: 'Activating our global networks and specialized pipelines.' },
  { title: 'Candidate Evaluation', icon: UserCheck, desc: 'Rigorous vetting against industry standards and fit.' },
  { title: 'Client Coordination', icon: CalendarDays, desc: 'Seamless management of the industry selection process.' },
  { title: 'Onboarding Support', icon: Rocket, desc: 'Ensuring long-term sector-aligned retention success.' }
];
