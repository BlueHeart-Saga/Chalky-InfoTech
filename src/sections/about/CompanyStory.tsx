      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="grid lg:grid-cols-2 gap-16 items-center">
          ...
          <motion.div initial={{ opacity: 0, x: -20 }} whileInView={{ opacity: 1, x: 0 }} viewport={{ once: true }} className="relative">
            <div className="aspect-square rounded-3xl bg-[#F8F5F0] overflow-hidden relative border border-[#E5E7EB]">
               ...
               <div className="absolute inset-8 border-2 border-dashed border-[#7A1F5C]/15 rounded-2xl flex items-center justify-center">
                 <span className="text-[#7A1F5C]/20 font-black text-6xl tracking-tighter">Est. 2009</span>
               </div>
            </div>
            <div className="absolute -bottom-8 -right-8 bg-white p-6 rounded-2xl shadow-xl border border-[#E5E7EB] max-w-[240px]">
              <p className="text-transparent bg-clip-text bg-gradient-to-r from-[#7A1F5C] to-[#C2185B] font-black text-5xl mb-2">10K+</p>
          ...
          <motion.div initial={{ opacity: 0, y: 20 }} whileInView={{ opacity: 1, y: 0 }} viewport={{ once: true }}>
            ...
            <h2 className="text-4xl lg:text-5xl font-black text-[#111827] mb-8 leading-tight tracking-tight">
              Scaling Growth Through <br/> <span className="text-transparent bg-clip-text bg-gradient-to-r from-[#7A1F5C] to-[#C2185B]">Exceptional Talent</span>
            </h2>
