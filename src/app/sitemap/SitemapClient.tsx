    ...
    <main className="min-h-screen bg-[#FDFCFB] pt-32 pb-40 overflow-x-hidden">
      <div className="max-w-[1400px] mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="relative flex flex-col items-center">
          ...
          <div className="w-full max-w-[1300px] relative mb-16 hidden xl:block">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 xl:grid-cols-6 gap-8 w-full max-w-[1400px] mb-24 px-4">
            ...
            <div className="flex flex-col items-center">
              <Node label="Regional Offices" href="/contact#locations" variant="default" icon={MapPin} delay={0.82} />
              <DottedLine className="h-10 my-4" />
              <div className="space-y-3 w-full flex flex-col items-center">
                {LOCATIONS.map((link, i) => (
                  <Node key={link.slug} label={link.city} href={`/locations/${link.slug}`} variant="ghost" delay={0.92 + (i * 0.05)} />
                ))}
              </div>
            </div>
