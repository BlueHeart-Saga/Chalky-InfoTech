...
const CATEGORY_ICONS: Record<string, any> = {
  "GDPR Fundamentals": ShieldCheck,
  "Lawful Processing & Consent": Scale,
  "Special Category Data": ShieldCheck,
  "Global Data Transfers": Globe,
  "Data Subject Rights": UserCheck,
...
export default function GDPRPage() {
  ...
  const filteredData = useMemo(() => {
    if (!searchQuery) return GDPR_COMPLIANCE_DATA;
    
    return GDPR_COMPLIANCE_DATA.map(cat => ({
      ...cat,
    ...
    <div className="min-h-screen bg-[#F5F0E8]">
      ...
      <section className="pt-32 pb-20 bg-[#7A1F5C] text-white overflow-hidden relative">
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10 text-center">
          ...
          >
            GDPR <span className="text-[#F5A7CB]">Compliance</span>
          </motion.h1>
          <motion.p 
            initial={{ opacity: 0, y: 20 }}
            animate={{ opacity: 1, y: 0 }}
          ...
          >
            Explore our rigorous commitment to data protection under the General Data Protection Regulation.
          </motion.p>
          ...
          >
            <div className="relative">
              ...
              <input 
                type="text"
                placeholder="Search GDPR clauses (e.g. rights, consent, transfer)..."
                value={searchQuery}
          ...
          <div className="grid lg:grid-cols-4 gap-12">
            ...
            <aside className="lg:col-span-1 hidden lg:block">
              <div className="sticky top-32 space-y-2">
                <h3 className="text-[#1A1A1A] font-bold text-sm uppercase tracking-wider mb-6 ml-4">GDPR Pillars</h3>
                {GDPR_COMPLIANCE_DATA.map((cat, idx) => {
      ...
      <section className="pb-32">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="bg-[#1A1A1A] rounded-[40px] p-8 md:p-16 text-center text-white relative overflow-hidden">
            <h2 className="text-3xl md:text-4xl font-semibold mb-6">GDPR Questions?</h2>
            <p className="text-white/60 mb-10 max-w-lg mx-auto">Our Data Protection Officer (DPO) is available to handle any complex inquiries regarding your data rights.</p>
            <div className="flex flex-col sm:flex-row items-center justify-center gap-4">
              <a href="/contact" className="bg-[#7A1F5C] px-8 py-4 rounded-full font-bold hover:bg-[#9D2877] transition-all flex items-center gap-2">
                Contact DPO <ChevronRight size={18} />
              </a>
